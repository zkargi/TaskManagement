...
describe('add-app-template', () => {
    it('should add DevExtreme', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const tree = yield runner.runSchematic('add-app-template', {}, appTree);
    ...
    it('should consider the `project` option', () => __awaiter(void 0, void 0, void 0, function* () {
        appTree = yield schematicRunner.runSchematic('application', {
            name: 'testApp2',
            inlineStyle: false,
            inlineTemplate: false,
            routing: true,
        ...
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematic('add-app-template', {
            project: 'testApp2'
        }, appTree);
        expect(tree.files)
    ...
    it('should consider the `updateBudgets` option', () => __awaiter(void 0, void 0, void 0, function* () {
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematic('add-app-template', { updateBudgets: true }, appTree);
