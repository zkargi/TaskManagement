...
export declare class DxContextMenuComponent<TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    dataSourceChange: EventEmitter<Store | DataSource | DataSourceOptions | null | string | Array<dxContextMenuItem>>;
    /**
     ...
     */
    targetChange: EventEmitter<UserDefinedElement | string | undefined>;
    /**
