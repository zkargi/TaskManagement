...
export declare class DxiSortByGroupSummaryInfoComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiSortByGroupSummaryInfoComponent, "dxi-sort-by-group-summary-info", never, { "groupColumn": { "alias": "groupColumn"; "required": false; }; "sortOrder": { "alias": "sortOrder"; "required": false; }; "summaryItem": { "alias": "summaryItem"; "required": false; }; }, {}, never, never, false, never>;
}
