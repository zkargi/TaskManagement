...
export declare class DxiRowComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiRowComponent, "dxi-row", never, { "baseSize": { "alias": "baseSize"; "required": false; }; "ratio": { "alias": "ratio"; "required": false; }; "screen": { "alias": "screen"; "required": false; }; "shrink": { "alias": "shrink"; "required": false; }; }, {}, never, never, false, never>;
}
