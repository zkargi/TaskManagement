...
import { useGetTeamListQuery } from "../../redux/slices/api/userApiSlice"; // Import the query hook

const UserList = ({ setTeam, team }) => {
  const { data: users = [], isLoading } = useGetTeamListQuery(); // Fetch users from API
